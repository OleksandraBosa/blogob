...
namespace ResumeBlog.Controllers
{
	public class PostsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PostId,Title,Content,Image,BlogId")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PostId,Title,Content,Image,BlogId")] Post post)
        {
            if (id != post.PostId)
            {
                return NotFound();
